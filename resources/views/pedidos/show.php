        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="d-flex flex-wrap gap-1">
                    <?php if (count($pedido->aprovacoes) > 0): foreach ($pedido->aprovacoes as $ap): ?>
...
<div class="card shadow-sm border-0 mb-4">
    ...
    <div class="table-responsive">
        <table class="table table-hover mb-0 align-middle">
            ...
            <tbody>
                <?php if (count($pedido->itens) > 0): foreach ($pedido->itens as $item): ?>
                    <tr>
                        <td class="ps-4">
        ...
        <div class="card shadow-sm border-0 h-100">
            ...
            <div class="card-body">
                <div class="timeline mt-3">
                    <?php if (count($pedido->alteracoes) > 0): foreach ($pedido->alteracoes as $alt): ?>
